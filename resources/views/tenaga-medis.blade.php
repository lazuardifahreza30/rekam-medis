          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">Tenaga Medis</a></li>
                          ...
                          <form id="form-barang" class="skin-default custom-scrollbar">
                            <!-- <div class="mt-10 grid grid-cols-12 gap-x-6 gap-y-2 sm:grid-cols-12"> -->
                              ...
                              <div class="sm:col-span-12">
                                <label for="tm_nama" class="block text-sm font-medium leading-6 text-gray-900">Nama</label>
                                <div class="mt-2">
                                  <input type="text" id="tm_nama" name="kode_fakultas" class="form-control" />
                                </div>
                              </div>
                              <div class="sm:col-span-12">
                                <label for="tm_jenis_kelamin" class="block text-sm font-medium leading-6 text-gray-900">Jenis Kelamin</label>
                                <div class="mt-2">
                                  <label>
                                    <input type="radio" name="tm_jenis_kelamin" id="tm_jenis_kelamin_L" class="" value="L" checked />
                                    <span>Laki - laki</span>
                                  </label>
                                  <label>
                                    <input type="radio" name="tm_jenis_kelamin" id="tm_jenis_kelamin_P" class="" value="P" />
                                    <span>Perempuan</span>
                                  </label>
                                </div>
                              </div>
                              <div class="sm:col-span-12">
                                <label for="tm_tanggal_lahir" class="block text-sm font-medium leading-6 text-gray-900">Tanggal Lahir</label>
                                <div class="mt-2">
                                  <input type="date" id="tm_tanggal_lahir" class="form-control" />
                                </div>
                              </div>
                              <div class="sm:col-span-12">
                                <label for="tm_alamat" class="block text-sm font-medium leading-6 text-gray-900">Alamat</label>
                                <div class="mt-2">
                                  <textarea id="tm_alamat" class="form-control"></textarea>
                                </div>
                              </div>
                              <div class="sm:col-span-12">
                                <label for="tm_no_handphone" class="block text-sm font-medium leading-6 text-gray-900">No. Handphone</label>
                                <div class="mt-2">
                                  <input type="text" id="tm_no_handphone" name="kode_fakultas" class="form-control" maxlength="13" />
                                </div>
                              </div>
                              <div class="sm:col-span-12">
                                <label for="tm_email" class="block text-sm font-medium leading-6 text-gray-900">E-mail</label>
                                <div class="mt-2">
                                  <input type="text" id="tm_email" name="kode_fakultas" class="form-control form-control-sm" />
                                </div>
                              </div>
  ...
  function loadData() {
    ...
    var table = $('#datatable').DataTable({
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#datatable').find('.actionUbah').on('click', function(e) {
              let id = $(this).attr('data-tm')

              $.ajax({
                url: 'tenaga-medis/getData',
                type: 'GET',
                data: {
                  tm_id: id
                },
                ...
                success: function(response) {
                  ...
                  $.each($('[name="tm_jenis_kelamin"]'), (i, item) => {
                    if (item.value == response[0].tm_jenis_kelamin)
                      item.checked = true
                  })
      ...
      columns: [
        ...
        { data: 'tm_nama', name: 'tm_nama' },
        { data: 'tm_jenis_kelamin', name: 'tm_jenis_kelamin' },
        { data: 'tm_tanggal_lahir', name: 'tm_tanggal_lahir' },
        { data: 'tm_alamat', name: 'tm_alamat' }
      ],
